...
class AssistantRouter:
    ...
    def __init__(self):
        ...
        # Modèle 1B : ultra-léger pour les réponses hors-contexte médical
    ...
    def route(self, question: str) -> dict:
        ...
        return {"type": "chat", "answer": answer, "sources": []}
    
if __name__ == "__main__":
    router = AssistantRouter()
    print("\n" + "-" * 50)
    print("HYBRID ASSISTANT IS ONLINE (Optimized with Llama 3.2)")
    ...
    while True:
        ...
        print(f"--- Route Selected: {result['type']} ---")
